...
export default function Home() {
  ...
  const vsCode = activities
    .find((activity: any) => activity.name === process.env.VSCODE);
            ...
            >
              <div className="flex justify-between items-start pt-2">
                ...
                <div className="w-96 lg:w-48 indicator flex justify-end">
                  {!isLoading && (
                    <>
                      <Image src={`https://cdn.discordapp.com/avatars/${discordData?.discord_user.id}/${discordData?.discord_user.avatar}?size=1024`} alt="tunalyy" height={1024} width={1024} className="rounded-full lg:w-20 lg:h-20 h-34 w-96" />
